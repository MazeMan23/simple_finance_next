        ...
        <div className="flex mr-3 ml-3 mt-3 flex-row md:mr-20 md:ml-20 md:mt-20">
          <div className="flex flex-col">
            ...
            <ul className="list-disc ml-5 mt-5  marker:text-orange-500">
              <h2 className="text-xl font-bold text-black">{t("whatWeDoTitle")}</h2>
              <li className="mb-2 mt-2 ml-8">{t("whatWeDo")}</li>
              <h2 className="text-xl font-bold text-black">{t("ourMissionTitle")}</h2>
              <li className="mb-2 mt-2 ml-8">{t("ourMission")}</li>
            </ul>
          </div>
          <div className="hidden self-center lg:flex justify-center">
            <video autoPlay loop className="ml-10 mb-10 max-w-lg">
